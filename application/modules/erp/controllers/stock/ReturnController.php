 ...
 * @abstract 
 */
class Erp_Stock_ReturnController extends Zend_Controller_Action
{
    ...
    public function getcanbereturnlistAction()
    {
        $request = $this->getRequest()->getParams();
        
        $key = isset($request['key']) && $request['key'] != '' ? $request['key'] : null;
        
        $order = new Erp_Model_Purchse_Receiveitemsorder();
        
        echo Zend_Json::encode($order->getCanBeReturnQty($key));
