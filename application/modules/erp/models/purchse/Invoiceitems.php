 ...
 * @abstract 
 */
class Erp_Model_Purchse_Invoiceitems extends Application_Model_Db
{
    /**
     * 表名、主键
     */
    protected $_name = 'erp_pur_invoice_items';
    ...
    public function getQty($item_id, $approved = null)
    {
        ...
        $sql = $this->select()
                    ...
                    ->joinLeft(array('t2' => $this->_dbprefix.'erp_pur_invoice'), "t1.invoice_id = t2.id")
