 ...
 * @abstract 
 */
class Erp_Model_Purchse_Type extends Application_Model_Db
{
    /**
     * 表名、主键
     */
    protected $_name = 'erp_pur_type';
    ...
    {
        $sql = $this->select()
                    ->from($this, array('id', 'name', 'chk_package_qty'))
    ...
    public function getData($id = null)
    {
        ...
        if($id){
            ...
            for($i = 0; $i < count($data); $i++){
                ...
                $data[$i]['chk_package_qty'] = $data[$i]['chk_package_qty'] == 1 ? true : false;
            }
        }
