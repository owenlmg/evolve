 ...
 * @abstract 
 */
class Erp_Model_Warehouse_Warehousetype extends Application_Model_Db
{
    /**
     * 表名、主键
     */
    protected $_name = 'erp_warehouse_type';
    protected $_primary = 'id';
    
    // 获取类别清单
    public function getList(){
        $sql = $this->select()
                    ->from($this, array('id', 'name' => new Zend_Db_Expr("concat(code, ' ', name)"), 'code'))
                    ->order('code');
