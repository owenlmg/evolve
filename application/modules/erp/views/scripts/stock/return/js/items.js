...
Ext.define('Items', {
    ...
    fields: [{name: "items_id"},
             ...
             {name: "items_order_supplier_code"},
...
var itemsRowEditing = Ext.create('Ext.grid.plugin.CellEditing', {
    ...
    listeners: {
    	beforeedit: function(editor, e){
    		if(Ext.getCmp('returnSaveBtn').isDisabled()){
    			return false;
    		}
    	}
    }
...
function printOrder(){
	...
	if(id != null){
	    ...
	    Ext.Ajax.request({
	        url: homePath + '/public/erp/stock_index/getprint/type/return/id/' + id,
	        params: '',
	        method: 'POST',
...
var itemsForm = Ext.create('Ext.form.Panel', {
	id: 'itemsForm',
	border: 0,
    url: homePath+'/public/erp/stock_index/editreceive/pre/POO',// POO：采购退货（默认POI：采购收货）
    bodyPadding: '2 2 0',
    fieldDefaults: {
        msgTarget: 'side',
        labelWidth: 75
        ...
        handler: function() {
            ...
            if(form.isValid()){
            	...
            	if(itemsStore.getCount() > 0){
                                        ...
                                        if(data.success){
                                            ...
                                            if(data.receive_id){
                                                ...
                                                //if(changeRowCnt > 0){
                                                    ...
                                                    Ext.Ajax.request({
                                                        url: homePath+'/public/erp/stock_return/edititems',
                                                        params: {json: json},
                                                        method: 'POST',
                                                        success: function(response, options) {
                                                            var data = Ext.JSON.decode(response.responseText);
                                            ...
                                            if(errInfo != ''){
                                                ...
                                                Ext.getCmp('returnGrid').getSelectionModel().clearSelections();
                                            }
                                        }else{
            		...
            		Ext.MessageBox.alert('错误', '请添加收货采购订单项目！');
            	}
            }
        }
    },{
