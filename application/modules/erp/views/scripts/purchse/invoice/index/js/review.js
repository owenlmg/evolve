...
var reviewForm = Ext.create('Ext.form.Panel', {
	id: 'reviewForm',
	border: 0,
    url: homePath+'/public/erp/purchse_invoice_index/review',
    bodyPadding: '5 5 0',
    fieldDefaults: {
        msgTarget: 'side',
        labelWidth: 75,
...
// 审核窗口
var reviewInvoiceWin = Ext.create('Ext.window.Window', {
	title: '审核',
	border: 0,
	id: 'reviewInvoiceWin',
	width: 500,
                        ...
                        if(button == 'yes'){
                                ...
                                success: function(form, action) {
                                    ...
                                    if(data.success){
                                        ...
                                        reviewInvoiceWin.hide();
                                        invoiceWin.hide();
                                        Ext.getCmp('reviewBtn').disable();
                                        Ext.getCmp('invoiceGrid').getView().getSelectionModel().clearSelections();
                                        invoiceStore.reload();
                                    }else{
