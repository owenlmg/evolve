...
var reviewForm = Ext.create('Ext.form.Panel', {
	id: 'reviewForm',
	border: 0,
    url: homePath+'/public/erp/sale_price/review',
    bodyPadding: '5 5 0',
    fieldDefaults: {
        msgTarget: 'side',
        labelWidth: 75,
...
// 审核窗口
var reviewPriceWin = Ext.create('Ext.window.Window', {
	title: '审核',
	border: 0,
	id: 'reviewPriceWin',
	width: 500,
                        ...
                        if(button == 'yes'){
                                ...
                                success: function(form, action) {
                                    ...
                                    if(data.success){
                                        ...
                                        Ext.getCmp('priceGrid').getView().getSelectionModel().clearSelections();
                                        priceStore.reload();
                                    }else{
